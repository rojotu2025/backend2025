...
const allowlist = [process.env.CORS_ROJOTU, process.env.CORS_UAT, process.env.CORS_LOCAL, process.env.LOCAL_FRONT,process.env.CORS_ROJOTU_D,process.env.CORS_ROJOTU_W]
