...
const userHasIdentityR = async (userS) => {
    try {
...
const userHasChangedIdentityR = async (userS, identidad) => {
    try {
...
module.exports = { searchUserR, cambiarContrasenaR, logsLogIn, reportUsuariosR, tabPedidosR, reportZonasR, reportLogsR, userHasIdentityR, userHasChangedIdentityR }