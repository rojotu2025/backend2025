const { searchUserR, cambiarContrasenaR, logsLogIn, tabPedidosR, reportUsuariosR, reportZonasR, reportLogsR, updateUserPedidoR, updateUserIdentityR} = require("../repository/repository.user");
...
const userHasChangedIdentityS = async(req, res) =>{
    let response = {
        code: "",
        message: "",
        data: {},
