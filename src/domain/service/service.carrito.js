const { buscarCarritoR, actualizarCarritoR, quitarPrendaR, agregarPrendaR, enviarCarritoR } = require("../repository/repository.carrito.js");
    ...
    if ((isValid).code == 200) {
        ...
        if (pedidoEnviado) {
            try {
                ...
                mailPedidoS(user.correo, "Coleccion RojoTu", `Tu pedido ha sido enviado exitosamente!`, user.nombre, d.usuario)
                response.code = 200,
