...
/** Check si usurario ha registrado identidad de genero */
const userHasIdentityC = async (req, res) => {
    const response = await userHasIdentityS(req, res);
    res.status(response.code).json(response)
}
...
module.exports = { authUserC, recuperarContrasenaC, cambiarContrasenaC, agregarCorreoC, reportUsuariosC, tabPedidosC, reportZonasC, reportLogsC, userHasIdentityC, userHasChangedIdentityC};