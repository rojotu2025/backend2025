const { authUserS, recuperarContrasenaS, cambiarContrasenaS, agregarCorreoS, reportPedidosS, tabPedidosS, reportZonasS, reportUsuariosS, reportLogsS  } = require("../../domain/service/service.user");
...
module.exports = { authUserC, recuperarContrasenaC, cambiarContrasenaC, agregarCorreoC, reportUsuariosC, tabPedidosC, reportZonasC, reportLogsC };