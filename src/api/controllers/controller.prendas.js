...
const listarPrendasC1 = async (req, res) => {
    const response = await listarPrendasS(req.header("token"), req.body.genero, req.body.rol, req.body.clima, req.body.grupo, req.body.pais);
    return res.status(response.code).json(response)
}

const listarPrendasFrontC = async (req, res) => {
    const response = await listarPrendasFrontS(req.header("token"), req.body.genero, req.body.rol, req.body.clima, req.body.grupo, req.body.pais);
    return res.status(response.code).json(response)
}
...
module.exports = { listarPrendasC, listarPrendasFrontC, buscarPrendasOutfitC };