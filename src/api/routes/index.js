...
const { listarPrendasC, buscarPrendasOutfitC, buscarPrendaC } = require("../controllers/controller.prendas");
const { listarLookbooksC } = require("../controllers/controller.lookbook");
...
/*Lookbook*/
routers.post('/listarlookbooks', bodyParser.json(), listarLookbooksC)
