...
const { authUserC, recuperarContrasenaC, cambiarContrasenaC, reportUsuariosC, reportPedidosC, tabPedidosC, reportZonasC, reportLogsC, searchIdentityC, userHasChangedIdentityC} = require("../../api/controllers/controller.user");
