...
const { authUserC, recuperarContrasenaC, cambiarContrasenaC, reportUsuariosC, reportPedidosC, tabPedidosC, reportZonasC, reportLogsC } = require("../../api/controllers/controller.user");
